...
namespace glw {
	enum Key {
		...
		KEY_J = 74, KEY_K = 75, KEY_L = 76, KEY_M = 77, KEY_N = 78, KEY_O = 79, KEY_P = 80, KEY_Q = 81, KEY_R = 82, KEY_S = 83, KEY_T = 84,
		...
		KEY_APOSTROPHE = 39, KEY_COMMA = 44, KEY_MINUS = 45, KEY_PERIOD = 46, KEY_SLASH = 47, KEY_SEMICOLON = 59, KEY_EQUAL = 61,
		KEY_LEFT_BRACKET = 91, KEY_RIGHT_BRACKET = 93, KEY_BACKSLASH = 92, KEY_GRAVE_ACCENT = 96,
		...
		KEY_MENU = 348, KEY_LAST = KEY_MENU,

		KEY_F1 = 290, KEY_F2 = 291, KEY_F3 = 292, KEY_F4 = 293,	KEY_F5 = 294, KEY_F6 = 295, KEY_F7 = 296, KEY_F8 = 297, KEY_F9 = 298, KEY_F10 = 299,
		KEY_F11 = 300, KEY_F12 = 301, KEY_F13 = 302, KEY_F14 = 303, KEY_F15 = 304, KEY_F16 = 305, KEY_F17 = 306, KEY_F18 = 307, KEY_F19 = 308,
		KEY_F20 = 309, KEY_F21 = 310, KEY_F22 = 311, KEY_F23 = 312, KEY_F24 = 313, KEY_F25 = 314
	};
	...
	public:
		...
		void addKeyListener(Listener&);
		void addMouseListener(Listener&);
		void addWindowListener(Listener&);

		void getMousePosition(int& x, int& y) const;
		void hideCursor(bool);

		void removeErrorListener(Listener&);
		void removeKeyListener(Listener&);
		void removeMouseListener(Listener&);
		void removeWindowListener(Listener&);
	...
	class Window {
		...
		bool m_fullscreen;
	public:
		Window(const char* title, uint width, uint height, bool fullscreen);
		~Window();
